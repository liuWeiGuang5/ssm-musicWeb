	...
	<section class="vbox">
		<header
			...
			<form
				...
				role="search" action="<%=basePath%>music/searchMusic">
				<div class="form-group">
					<div class="input-group">
						...
						</span> <input type="text" name="searchName" value="${searchName}"
			...
			<div class="navbar-right ">
				...
				<c:if test="${empty user}">
					...
					<span>&emsp;</span>
					<a href="../signup.jsp" ><span class="glyphicon glyphicon-new-window"></span>&nbsp;免费注册</a>
				</c:if>
				<span>&emsp;</span>
								...
								<nav class="nav-primary hidden-xs">
									<ul class="nav bg clearfix">
										<li class="hidden-nav-xs padder m-t m-b-sm text-xs text-muted">
											发现</li>
										<li><a href="<%=basePath%>music/getComendMusics"> <i
												...
												<div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
													<div class="item">
														<div class="pos-rlt">
															...
															<a href="#"><img src="/musicfile/${m.musicphotourl}" alt="" width="120px" height="250px"
														...
														<div class="col-xs-6 col-sm-3">
															<div class="item">
																<div class="pos-rlt">
																	...
																	<a href="#"><img src="/musicfile/${n.musicphotourl}"
																		alt="${n.title }" width="120px" height="230px" class="r r-2x img-full" ></a>
																</div>
																<div class="padder-v">
																	<a href="#" class="text-ellipsis">${n.musicname }</a> <a
																		href="#" class="text-ellipsis text-xs text-muted">${n.singer.singername}</a>
																</div>
															</div>
														</div>
													</c:forEach>
													...
													<c:forEach var="m" items="${topSongs}" varStatus="st">
														<a href="#" class="list-group-item clearfix jp-play-me TopSongs" st="${st.index}"> <span
															class="pull-right h2 text-muted m-l">${st.index+1}
																...
																class="text-muted clear text-ellipsis">${m.singer.singername}</small>
														</span>
														</a>
													</c:forEach>
												</c:if>
									...
									<div class="row m-t-lg m-b-lg">
										<div class="col-sm-6">
											<div class="bg-primary wrapper-md r">
												<a href="<%=basePath%>login.jsp"> <span class="h4 m-b-xs block"><i
											...
											<c:forEach var="n" items="${topSingers}">
												<li class="list-group-item"><span
													class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
														<img src="/musicfile/${n.singerphotourl}" alt="..."
