									...
									<section class="vbox animated fadeInUp">
										<section class="scrollable hover">
											...
											<div
												...
												<c:if test="${nowtype==0 }">
													<a href="<%=basePath%>music/getTypes?typeid=0" class="list-group-item active">
														全部 </a>
												</c:if>
												<c:if test="${nowtype!=0 }">
													<a href="<%=basePath%>music/getTypes?typeid=${musicty.musictypeid }" class="list-group-item"> 全部 </a>
												</c:if>
												<c:if test="${not empty tlist }">
													<c:forEach var="musicty" items="${tlist }">
														<c:if test="${musicty.musictypeid==nowtype }">
															<c:set var="nowtypename"
																value="${musicty.musictypename }"></c:set>
															<a class="list-group-item active"
																href="<%=basePath%>music/getTypes?typeid=${musicty.musictypeid}">
									...
									<section class="vbox">
										<section class="scrollable padder-lg">
															...
															<div class="item">
																<div class="pos-rlt">
																	...
																	<a href="track-detail.html"><img
																		src="/musicfile/${pm.musicphotourl }" alt="" width="100px" height="230px"
											...
											<ul class="pagination pagination">
												...
												<c:if test="${info.pageNum-1>=1 }">
													<li><a
														href="<%=basePath%>music/getTypes?typeid=${nowtype }&pageNO=${info.pageNum-1 }"><i
												...
												<c:if test="${not empty info.list }">
													<c:forEach begin="1" end="${info.pages }" step="1"
														...
														<c:if test="${i!=info.pageNum}">
															<li><a
																href="<%=basePath%>music/getTypes?typeid=${nowtype }&pageNO=${i }">${i }</a></li>
														</c:if>
													</c:forEach>
												</c:if>
