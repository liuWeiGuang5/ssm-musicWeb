    ...
    <div class="container aside-xl">
      ...
      <section class="m-b-lg">
        ...
        <form action="<%=basePath%>user/register" method="post">
          ...
          <div class="form-group">
            <input type="email" placeholder="邮件" class="form-control rounded input-lg text-center no-border" name="email">
          </div>
          <div class="form-group">
             <input type="password" placeholder="密码" class="form-control rounded input-lg text-center no-border" name="password" id="userPwd">
          ...
          <a href="login.jsp" class="btn btn-lg btn-info btn-block btn-rounded">登录</a>
        </form>
      </section>
    </div>
  </section>
